...
namespace NUnit.ConsoleRunner
{
	...
	public class ConsoleOptions : CommandLineOptions
	{
        ...
        [Option(Description = "List the test tree")]
        public bool gui_list;

        [Option(Description = "Wait for debugger")]
        public bool gui_wait;

        [Option(Description = "Run in BoostTestUi")]
        public bool gui_run;
