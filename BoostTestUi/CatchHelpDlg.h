...
#ifndef BOOST_TESTUI_CATCHHELPDLG_H
#define BOOST_TESTUI_CATCHHELPDLG_H
...
class CCatchHelpDlg :
	public CDialogImpl<CCatchHelpDlg>,
	public CDialogResize<CCatchHelpDlg>
{
public:
	static const int IDD = IDD_CATCHHELP;

	BEGIN_MSG_MAP(CCatchHelpDlg)
		MSG_WM_INITDIALOG(OnInitDialog)
		MSG_WM_CONTEXTMENU(OnContextMenu);
		COMMAND_ID_HANDLER_EX(ID_SAMPLE_COPY, OnCopy)
		COMMAND_ID_HANDLER_EX(IDOK, OnCloseCmd)
		COMMAND_ID_HANDLER_EX(IDCANCEL, OnCloseCmd)
		CHAIN_MSG_MAP(CDialogResize<CCatchHelpDlg>)
	END_MSG_MAP()

	BEGIN_DLGRESIZE_MAP(CCatchHelpDlg)
...
#endif // BOOST_TESTUI_CATCHHELPDLG_H
